...
import { Layout, BackTop, Menu, Button } from 'antd';
...
export default function Charts() {
    ...
    const [showMoreCharts, setShowMoreCharts] = useState({
        show: true,
        text: 'Hide Charts'
    })
    const showMoreChartsHandler = () => {
        let flag = showMoreCharts.show;
        setShowMoreCharts({
            show: !flag,
            text: !flag ? 'Hide Charts' : 'Show More Charts'
        })
    }
                    ...
                    <Content>
                        ...
                        <div className="charts">
                            ...
                            <Button
                                type="danger"
                                shape='round'
                                onClick={showMoreChartsHandler}
                            >{showMoreCharts.text}</Button>
                            {otherCharts}
                        </div>
